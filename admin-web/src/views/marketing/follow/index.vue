    ...
    <template v-slot:page-header-right>
      <a-space>
        <a-tooltip content="刷新">
          ...
          <a-button @click="onConfig" size="small">跟单配置</a-button>
          <followConfig ref="followConfigRef"></followConfig>
      </a-space>
    </template>
...
import followConfig from "./config.vue";
...
const followConfigRef = ref<HTMLElement>()

const onConfig = () => {
 proxy?.$refs["followConfigRef"]?.open();
}
</script>