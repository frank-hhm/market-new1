<template>
	<view>
		<view class="diy-tab-nav">
			<view v-for="(item,index) in bottomNav" :key="index" class="diy-tab-nav-item" @tap="toPath(item.page)">
	...
	export default {
		...
		data() {
			return {
				bottomNav: [{
					title: '跟单广场',
					icon: '/static/images-new1/tab-follow/index.png',
					icon_cur: '/static/images-new1/tab-follow/index_cur.png',
					page: "/otherpages/follow/index",
					isTab: true
				}, {
					title: '我的跟单',
					icon: '/static/images-new1/tab-follow/member.png',
					icon_cur: '/static/images-new1/tab-follow/member_cur.png',
					page: "/otherpages/follow/member"
				}]
			};
		},
		computed: {},
