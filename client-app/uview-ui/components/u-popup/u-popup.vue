<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<view
			...
			:style="[style]"
		>
			<view class="u-mode-center-box" :class="isBg == false?'':'is-bg'" @tap.stop.prevent @touchmove.stop.prevent v-if="mode == 'center'" :style="[centerStyle]">
				<u-icon
					@click="close"
					v-if="closeable"
					class="u-close"
		...
		<slot  v-if="closeSync" name="close"></slot>
	</view>
</template>
