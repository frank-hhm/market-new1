			...
			<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list"
						...
						{{ item[name] || item['name']}}
						<slot name="active" v-if="index == currentIndex"></slot>
					</view>
					<view v-if="showBar" class="u-tab-bar" :style="[tabBarStyle]"></view>
				</view>
				<view v-if="bgImage != ''" class="u-scroll-box-bg">
					<image class="u-scroll-box-bg-image" :src="bgImage" mode="scaleToFill"></image>
				</view>
			</scroll-view>
		</view>
	</view>
