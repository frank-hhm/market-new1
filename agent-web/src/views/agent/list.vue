          ...
          >
            <template #cell="{ record }">
              <a-switch
                ...
                :disabled="record.level?.value  < 2  || agentDetail.level?.value == record.level?.value"
                size="small"
                type="round"
          ...
          <a-table-column title="操作" align="center" :width="180">
            <template #cell="{ record }">
              <a-space>
                ...
                >
                <a-button
                v-if="record.level?.value > 1 && agentDetail.level?.value != record.level?.value"
                ...
                >
                <div 
                v-if="record.level?.value > 1  && agentDetail.level?.value != record.level?.value" v-permission="'agent-delete'">
                  <a-popconfirm
                    content="确定删除吗？"
