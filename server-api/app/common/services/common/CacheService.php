...
class CacheService  extends BaseService
{
    ...
    protected string $redisName = 'redis';

    public function setRedisName(string $redisName): \think\cache\Driver
    {
...
//            throw new CommonException($e->getMessage());
    ...
    ## Redis缓存句柄
    public function redis(): \think\cache\Driver
    {
        return CacheStatic::store($this->redisName);
    }
    public function redisHandler(): ?object
    {
