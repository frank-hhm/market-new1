...
class MarketItickForexXAUTask  extends AbstractProcess
{
    ...
    public function run($arg)
    {
        ...
        $runTime = 1000 * 30;
        $marketSource = MarketSourceEnum::ITICK_FOREX_AXU;
        ...
        $this->cacheKey = CacheKeyConstant::MARKET_ITICK_FOREX_AXU_STATUS;
        $taskName = "【Itick外汇黄金】";
